...
# 1. Archive previous v2 file
v2_src = os.path.join(workspace_reports, u"final", u"01_2027_수시_통합_지원전략_보고서.html")
archive_dest = os.path.join(workspace_reports, u"archive_history", u"20260810_v2_01_2027_수시_통합_지원전략_보고서.html")

if os.path.exists(v2_src):
    shutil.copy2(v2_src, archive_dest)

# 2. Build V3 Strategy Report HTML Content
html_content = u"""<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>2027학년도 진선여고 박정윤 수시 지원 5대 맞춤형 콤보 지원전략 보고서 (V3 최종완결판)</title>
    <style>
        :root {
            --bg-main: #f8fafc;
            --card-bg: #ffffff;
...
<div class="container">
    <!-- Header -->
    <div class="header">
        <h1>🎓 2027학년도 수시 지원 5대 맞춤형 콤보 지원전략 보고서 (V3 최종완결판)</h1>
    ...
    <div id="optA" class="option-section active">
        ...
        <div class="cards-grid">
            ...
            <div class="univ-card johap">
                ...
                <div class="strategic-comment">★ 9/9 17시 가장 빠른 1차 마감. 4합8 최저 충족 시 실질 경쟁률 3:1 이하로 급감하여 최저 맞추면 합격 가능성 대폭 상승!</div>
            </div>
            <!-- Card 2 -->
            ...
            <div class="univ-card nonsul">
                ...
                <div class="card-detail"><strong>모집단위 및 인원:</strong> 경영학부 36명 (창의형의 2배 규모!)</div>
                <div class="card-detail"><strong>전형방법:</strong> 논술 70% + 교과 20% + 출결 10%</div>
                <div class="card-detail"><strong>수능 최저기준:</strong> 3개 영역 합 6 이내 (영어 2->1등급 환산)</div>
                <div class="card-detail"><strong>시험일시:</strong> 2026-11-29 (일) 10:00 (경영) / 14:00 (인문)</div>
                <div class="strategic-comment">★ 경영 36명 대규모 선발 및 3합6 최저 충족 시 실질 경쟁률 급감! 수능 후 2주차 일요일 고사.</div>
            </div>
            <!-- Card 5 -->
            <div class="univ-card nonsul">
                <div class="univ-name">
                ...
                <div class="strategic-comment">★ 박정윤 학생 동국대 환산 4.80등급 적용 시 상위 10과목 반영으로 감점 약 0.4점에 불과! 확실한 안전판.</div>
            </div>
            <!-- Card 6 -->
            <div class="univ-card johap">
                <div class="univ-name">
                ...
                <div class="strategic-comment">★ 외대 환산 3.80등급으로 1단계 서류 통과 유의미하며, 2단계 면접 50%로 최종합격 유도.</div>
            </div>
        </div>
        ...
        <div class="univ-card special">
            ...
            <div class="card-detail"><strong>전형방법:</strong> 서류 100% | 수능 최저 없음</div>
            <div class="strategic-comment">★ 4대 과기원 중 유일한 경영계열 별도 선발! 진선여고 인문계 생기부로 최우선 무위험 지원.</div>
        </div>
    </div>
    ...
    <div id="optB" class="option-section">
        ...
        <div class="cards-grid">
            <div class="univ-card nonsul">
                <div class="univ-name">
                    <span>1. 중앙대 창의형 논술 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span>
                    <span class="type-badge type-nonsul">1차 수능전</span>
                </div>
                <div class="card-detail"><strong>시험일시:</strong> 수능 전 10/11 (일) 10:00 | 최저 없음 (고3 현역만)</div>
                <div class="strategic-comment">★ N수생 미반영 고3 현역 전용 카드로 수능 전 부담 없는 합격 기회 타깃팅!</div>
            </div>
            <div class="univ-card nonsul">
                <div class="univ-name">
                    <span>2. 중앙대 일반형 논술 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span>
                    <span class="type-badge type-nonsul">2차 수능후</span>
                </div>
                <div class="card-detail"><strong>시험일시:</strong> 수능 후 11/29 (일) 10:00 | 최저 3개 합 6</div>
                <div class="card-detail"><strong>모집인원:</strong> 경영학부 36명 (창의형의 2배 규모)</div>
                <div class="strategic-comment">★ 3합6 최저기준 충족 시 실질 경쟁률 급감 수혜로 중앙대 경영 2차 합격선 완성.</div>
            </div>
            <div class="univ-card nonsul">
                <div class="univ-name">
                    <span>3. 동국대 논술전형 <span class="deadline-tag tag-d3">9/11 17시 마감</span></span>
                    <span class="type-badge type-nonsul">논술전형</span>
                </div>
                <div class="card-detail"><strong>최저기준:</strong> 2개 영역 합 5 이내 | 환산 4.80</div>
                <div class="strategic-comment">★ 상위 10과목 반영으로 감점 약 0.4점에 불과한 확실한 2합5 실리 안전판.</div>
            </div>
            <div class="univ-card nonsul">
                <div class="univ-name">
                    <span>4. 경희대 논술우수자 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span>
                    <span class="type-badge type-nonsul">논술전형</span>
                </div>
                <div class="card-detail"><strong>최저기준:</strong> 2개 영역 합 5 이내 | 논술 100%</div>
                <div class="strategic-comment">★ 경영회계 27명 대규모 선발. 논술 100%로 내신 감점 0점.</div>
            </div>
            <div class="univ-card nonsul">
                <div class="univ-name">
                    <span>5. 성균관대 인문사회 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span>
                    <span class="type-badge type-nonsul">논술전형</span>
                </div>
                <div class="card-detail"><strong>최저기준:</strong> 3개 영역 합 6 이내 | 논술 100%</div>
                <div class="strategic-comment">★ 3합6 최저 달성 시 성균관대 합격 역전 도모.</div>
            </div>
            <div class="univ-card johap">
                <div class="univ-name">
                    <span>6. 한국외대 면접형 (종합) <span class="deadline-tag tag-d3">9/11 17시 마감</span></span>
                ...
                <div class="strategic-comment">★ 면접 50%로 안정적인 학생부종합 합격선 구축.</div>
            </div>
        </div>
    ...
    <div id="optD" class="option-section">
        ...
        <div class="cards-grid">
            <div class="univ-card johap">
                ...
                <div class="strategic-comment">★ 9/9 17시 최선두 1차 마감. 4합8 충족 시 실질 경쟁률 3:1 이하로 급감하여 서류 역전 합격 가능한 카리스마 카드.</div>
            </div>
            <div class="univ-card johap">
            ...
            <div class="univ-card nonsul">
                <div class="univ-name"><span>4. 중앙대 창의형 논술 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span><span class="type-badge type-nonsul">중앙대 더블 1차</span></div>
                <div class="card-detail"><strong>시험일시:</strong> 수능 전 10/11 | 최저 없음 (고3 현역만)</div>
                <div class="strategic-comment">★ 중앙대 동시 복수지원 1차: 고3 현역 전용 전형으로 수능 전 실전 경험 및 조기 합격 타깃팅.</div>
            </div>
            <div class="univ-card nonsul">
                <div class="univ-name"><span>5. 중앙대 일반형 논술 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span><span class="type-badge type-nonsul">중앙대 더블 2차</span></div>
                <div class="card-detail"><strong>시험일시:</strong> 수능 후 11/29 | 최저 3개 합 6 (경영 36명)</div>
                <div class="strategic-comment">★ 중앙대 동시 복수지원 2차: 경영 36명 대규모 모집 및 3합6 최저 충족 시 합격 확률 최고조.</div>
            </div>
            <div class="univ-card nonsul">
                <div class="univ-name"><span>6. 서강대 또는 성균관대 논술 <span class="deadline-tag tag-d4">9/11 18시 마감</span></span><span class="type-badge type-nonsul">논술 상향</span></div>
                <div class="card-detail"><strong>최저기준:</strong> 3개 영역 합 6~7 | 논술 100%</div>
                <div class="strategic-comment">★ 서강대 야간 고사(19시) 동선 완벽 수용 또는 성균관대 논술100% 선택.</div>
            </div>
        </div>
    ...
    <div id="optE" class="option-section">
        ...
        <div class="cards-grid">
            <div class="univ-card johap">
                <div class="univ-name"><span>1. 이화여대 미래인재 <span class="deadline-tag tag-d2">9/10 17시 마감</span></span><span class="type-badge type-johap">상향 종합</span></div>
                <div class="card-detail"><strong>최저기준:</strong> 2개 영역 합 5 | 서류 100% (면접 없음)</div>
                <div class="strategic-comment">★ 9/10 17시 2차 마감. 강남권 진선여고 성취도 및 2합5 최저 기반 상향 카드.</div>
            </div>
            <div class="univ-card nonsul">
...
print "SUCCESSFULLY_GENERATED_V3_STRATEGY_REPORT"
