$csvPath1 = "C:\Users\그램\Documents\antiG\reports\2027_univ_minimum_cutoffs.csv"
$csvPath2 = "C:\Users\그램\Desktop\프로세스\2027_대학별_수능최저학력기준_분석.csv"
$xlsPath1 = "C:\Users\그램\Documents\antiG\reports\2027_univ_minimum_cutoffs.xls"
$xlsPath2 = "C:\Users\그램\Desktop\프로세스\2027_대학별_수능최저학력기준_분석.xls"

$csvLines = @(
    "구분,수능 최저 등급 기준 (높은 순),대상 대학 / 학과,비고 및 메모 (선지문장/탐구/메타노트)",
...
[System.IO.File]::WriteAllLines($csvPath1, $csvLines, [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllLines($csvPath2, $csvLines, [System.Text.Encoding]::UTF8)
...
<table>
  ...
  <tr>
    <td>국/수/영/탐(1) 中 2개 합 6</td>
    <td>숭실대, 한국외대(글로벌), 동덕여대, 국민대, 항공대</td>
    <td>손글씨: 약술형으로 변경 (DP 프로세스 논술)</td>
  </tr>
  <tr>
    <td>국/수/영/탐(1) 中 2개 합 7</td>
    <td>성신여대, 덕성여대</td>
    <td>탐구 1과목 반영</td>
  </tr>
  <tr>
...
[System.IO.File]::WriteAllText($xlsPath1, $htmlXls, [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllText($xlsPath2, $htmlXls, [System.Text.Encoding]::UTF8)
Write-Host "XLS generated successfully."
